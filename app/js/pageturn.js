...
function pageRight() {
  ...
  document.getElementById("viewImgOne").src = fileDir + '/' + dirArray[index];   // Loads array[x] into window
  document.getElementById("viewImgTwo").src = fileDir + '/' + dirArray[index + 1]; // Loads array[x + 1] into window
};
